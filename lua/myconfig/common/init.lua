...
function M.setup()
  ...
  vim.keymap.set("n", "<leader>gj", function() goto_error_then_hint(1) end)
  vim.keymap.set("n", "<leader>gk", function() goto_error_then_hint(-1) end)

  -- Quickfix
  vim.keymap.set("n", "<leader>qfc", function() vim.fn.setqflist({}) end, { desc = "Clear quickfix" })
